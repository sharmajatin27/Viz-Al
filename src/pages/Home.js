	...
	const numOfCard = [
		[
			...
			},
			{
				...
				url: "/selectionsort",
				desc:
					"Selection Sort is  sorting algorithm that divides the input list into two parts: the sorted part and the unsorted part. Idea of this Sort is to repeatedly select the smallest element and swap it with the element at the beginning of the unsorted.  ",
			},
			{
				title: "Merge Sort",
				imgSrc: BubbleSortImg,
