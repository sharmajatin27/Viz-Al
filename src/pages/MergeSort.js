...
import mergeSortFun from "./components/utils/algorithms/mergesortfun";
...
const MergeSort = () => {
  ...
  const handleClick = async () => {
    if (arr.length !== 0) {
      ...
      message.warning({
        content: "Merge Sort is Running! Don't click any Button",
        key,
        duration: 0,
        style: {
          marginTop: "20vh",
      ...
      setDisable(true);
      await mergeSortFun(setArr, arr, time, setDisable);
